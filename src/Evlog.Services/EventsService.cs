        ...
        public List<Event> Get()
        {
            return new List<Event>(new Event[]{
                new Event
                {
                    ...
                    TimeStamp = new DateTime(2018, 4, 30, 15, 0, 0)
                },
                new Event
                {
                    ...
                    TimeStamp = new DateTime(1983, 5, 1, 15, 0, 0)
                },
                new Event
                {
                    ...
                    TimeStamp = new DateTime(2018, 5, 8, 12, 0, 0)
                },
                new Event
                {
                    ...
                    TimeStamp = new DateTime(2018, 5, 15, 12, 0, 0)
                },
                new Event
                {
                    ...
                    TimeStamp = new DateTime(2018, 5, 17, 7, 30, 0)
                },
                new Event
                {
                    ...
                    TimeStamp = new DateTime(2017, 8, 16, 2, 0, 0)
                }
            });
        }
    }
